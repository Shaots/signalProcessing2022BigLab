...
```
### Вход и выход 
Входа к этой функции: **ПОЛНЫЙ** путь к фотографии предметов, имеющий тип string <br>
...
4. угол наклона камеры должен быть меньше 45 градусов.
...
2. меньшая из сторон предмета была не менее 20 пикселей, а большая - не менее 200
6. предметы не должны перекрывать друг друга
7. длина и толщина предмета обе не должны превосходить 21 см.
